...
function parserMaker(inputname, typename, excel, sheetIndex) {

    var sheet = excel[sheetIndex];
...
function ruleMaker(rule, inputPath, outputPath) {
    ...
    for (var i in rule.fields) {
        ...
        var parser = parserMaker(field.inputname, field.typename, excel, sheetIndex);
